...
// 2. CONSTRÓI O HTML DE CADA CARD COM BASE NOS DADOS DO BANCO
        function renderizarCardsPlanos() {
            const container = document.getElementById('view-planos-padrao');
            if (window.planosCarregados.length === 0) return;
            ...
            window.planosCarregados.forEach((plano, index) => {
                ...
                // Monta a lista de Limites Dinâmicos (Topo da lista)
                ...
                // Monta a lista de Funcionalidades cruzando os Checkboxes
                ...
                baseFeatures.forEach(f => {
                    ...
                    if (hasAccess) {
                        ...
                        // Não tem acesso (Cortado, vermelho, opacidade 50%)
